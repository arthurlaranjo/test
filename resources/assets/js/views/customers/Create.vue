...
<v-container fluid pa-0>
    <v-card class="mb-5">
        ...
        <v-card-title v-if="!loading" primary-title class="primary white--text pt-3 pb-2"><h2 class="headline">Criar Cliente</h2></v-card-title>
        <v-card-text v-if="!loading">
